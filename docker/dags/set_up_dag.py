...
import json
import logging
import create_airflow_connections
...
create_aws_connection = create_airflow_connections.CreateConnections(
    ...
    login=Configuration.aws_key,
    pwd=Configuration.aws_pwd
)
create_redshift_connection = create_airflow_connections.CreateConnections(
    ...
    login=Configuration.redshift_user,
    pwd=Configuration.redshift_pwd,
    port=5439,
    host='redshift-cluster-1.clfzi5uom6bn.us-west-2.redshift.amazonaws.com',
    schema='dev'
)
